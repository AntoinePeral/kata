/*
Construis la requête SQL qui récupèrera le titre des livres, le nom de l'auteur du livre,
 le nom et le prénom des lecteurs et la date d'emprunt pour les livres non rendu à la date du jour 
 et dont l'emprunt date de plus de 2 semaines.
 
SELECT b.title, CONCAT(a.first_name,' ', a.last_name) AS authorName,
	 CONCAT(r.first_name, r.last_name) AS readerName,
	 l.loan_date AS date_emprunt
	FROM book AS b JOIN author AS a ON a.author_id = b.author_id 
	JOIN loan AS l ON l.book_id=b.book_id 
	JOIN reader AS r ON r.reader_id=l.reader_id 
WHERE l.return_date IS NULL AND DATEDIFF(CURRENT_DATE(),l.loan_date)>14;
*/
...
INSERT INTO `loan` VALUES (1,1,1,'2024-01-10','2024-02-10'),(2,3,3,'2024-01-20','2024-02-20'),(3,6,1,'2024-02-05','2024-03-05'),(4,7,2,'2024-02-10','2024-03-06'),(5,8,3,'2024-02-15','2024-03-03'),(6,2,2,'2024-01-15',NULL),(7,4,4,'2024-01-25',NULL),(8,5,5,'2024-02-01',NULL),(9,9,4,'2024-03-02',NULL),(10,10,5,'2024-03-10',NULL);
