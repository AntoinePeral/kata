...
function wordAcronym(sentence) {
    let acronym = []; // Tableau pour stocker les lettres de l'acronyme
    let numberLowerCaseLetter = 0; // Compteur pour les lettres minuscules
