 ...
 */
function sortByRating2(products) {
    return products.sort(function (a, b) { return b.rating - a.rating; });
}
/**
 * @returns It should return a number where:
 ...
 */
function sortByRating3(products) {
    return products.sort(function (a, b) { return a.rating - b.rating; }).reverse();
}
function filterByCategory(categoryName) {
    return products.filter(function (product) { return product.category.toUpperCase() === categoryName.toUpperCase(); });
}
console.log("------------------------------------------------------------");
