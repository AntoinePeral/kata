...
*/
function convertTemperature(value, fromUnity, toUnity) {
    let result;
    let fromUnityLowerCase = fromUnity.toLowerCase();
    let toUnityLowerCase = toUnity.toLowerCase();
...
console.log(convertTemperature(273.15, "KElvin", "toto")); // 32
console.log(convertTemperature(273.15, "kelvin", "kelvin")); // Erreur
